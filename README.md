...
확장자를 보고 **자동으로 알맞은 정리**가 적용되며, 결과 보고 형식·저장 규칙·
입력 옵션은 두 포맷에서 **동일하게 통일**되어 있습니다.
...
1. 파일 추가 — **드래그 앤 드롭** 또는 **파일 추가…** 버튼 (엑셀·PPT 섞어서 가능)
2. **정리 항목** 선택 — 엑셀 항목과 PPT 항목이 좌우로 나뉘어 있으며, 각 파일에는
   해당 종류의 옵션만 적용됩니다(엑셀 옵션은 PPT 파일에 영향을 주지 않음).
3. **저장 방식** 선택
